...
function DashboardView({ primaryLocation, totalSearches, recentSearches, uniqueCities }) {
  return (
    <section className="glass-lite fade-soft weather-refresh w-full max-w-5xl rounded-[34px] p-6 shadow-ambient md:p-8">
      <div className="space-y-10">
        ...
        <div className="section-enter" style={{ animationDelay: '90ms' }}>
          ...
          <div className="mt-4 grid grid-cols-2 gap-5 md:grid-cols-3">
            <article className="soft-hover-lift rounded-2xl bg-white/20 px-4 py-3">
            ...
            <article className="soft-hover-lift col-span-2 rounded-2xl bg-white/20 px-4 py-3 md:col-span-1">
          ...
          <div className="mt-4 space-y-2">
            {recentSearches.length === 0 ? (
              ...
              recentSearches.map((item, idx) => (
                <article key={`${item.city}-${idx}`} className="soft-hover-lift rounded-2xl bg-white/33 px-4 py-3">
