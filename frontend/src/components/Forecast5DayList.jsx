...
function Forecast5DayList({ daily }) {
  return (
    <section>
      <p className="mb-3 text-xs font-medium uppercase tracking-[0.16em] text-inkTertiary">5 Day</p>
      <div className="space-y-3">
        {daily.map((day) => {
          const Icon = iconByCondition(day.condition);
          return (
            <article key={day.date} className="flex items-center justify-between rounded-2xl bg-white/35 px-3 py-2.5">
